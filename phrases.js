module.exports = {
  'win': ["Easy %s victory.",
          ...
          "After the %s victory today, all I can say is that footbal is a game about feeling and intelligence.",
  ...
  'tie': ["Everyone wants to park the bus...and then you get %s.",
          "They play with 3 goalies. I cannot play against 3 goalies. They want %s, not me.",
  ...
  'lost': ["We deserved not to lose %s.",
          "Referee must give that penalty to Chelsea. We cannot play against the referee. %s is a fake score.",
          "No comment. If I say something, I get in trouble. If I say nothing - I get in trouble. So - no comment. It is %s, that's it",
          "Lost %s ? No...no, no no...just...no.",
          "We need one more...maybe two more good horses and then %s defeats won't happen.",
          "I am Jose Mourinho and I don't change. I arrive with all my qualities and my defects. %s defeat is part of it.",
          "Unhappy is a nice word after %s defeat.",
